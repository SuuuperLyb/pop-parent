...
//            tStarService.getMainStarInfo();
                IPage<TStarStyle> firstPage = tssm.selectPage(new Page<TStarStyle>(1,pageSize),new QueryWrapper<TStarStyle>().orderByDesc("like_num"));
                jedisCore.set("hotStarInfo",24*68*60, JSONObject.toJSONString(firstPage));
